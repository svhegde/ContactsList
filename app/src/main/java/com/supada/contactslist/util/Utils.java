...
package com.supada.contactslist.util;

import android.annotation.TargetApi;
import android.os.Build;
import android.os.StrictMode;

import com.supada.contactslist.ui.ContactDetailActivity;
import com.supada.contactslist.ui.ContactsListActivity;
...
public class Utils {
    ...
    public static void enableStrictMode() {
        ...
        if (Utils.hasGingerbread()) {
            ...
            if (com.supada.contactslist.util.Utils.hasHoneycomb()) {
